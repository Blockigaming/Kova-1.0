...
CHAT_POLICIES = {
    ...
    "high": {
        "engine": "kova-core", "profile": "nova", "reasoning_effort": "xhigh",
        "passes": (1, 1, 1, 1), "activity_updates": True, "thinking_enabled": True,
        "display_name": "Kova 5.6 Nova",
    ...
    "ultra": {
        "engine": "kova-ultra", "profile": "ultra", "reasoning_effort": "xhigh",
        "dynamic_agents": (2, 5), "judge": True, "synthesis": True, "activity_updates": True,
        "display_name": "Kova Ultra",
...
WORK_FAMILY_POLICIES = {
    "cosmo": {
        "family_display_name": "Kova 5.6 Cosmo",
    ...
    "orion": {
        "family_display_name": "Kova 5.6 Orion",
    ...
    "nova": {
        "family_display_name": "Kova 5.6 Nova",
...
def resolve_route(request):
    ...
    if surface == "chat":
        _require(set(request) == {"surface", "route_id"}, "unsupported chat route fields")
